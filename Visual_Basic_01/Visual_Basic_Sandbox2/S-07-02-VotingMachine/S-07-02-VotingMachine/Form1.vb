Public Class frmVotingMachine

  Dim totals() As Integer
  Private Sub frmVotingMachine_Load(sender As Object, e As EventArgs) Handles MyBase.Load

  End Sub

  Private Sub btnNominate_Click(sender As Object, e As EventArgs) Handles btnNominate.Click
    Dim candidate As String
    candidate = InputBox("Please enter the name of the candidate", "Candidate")
  ...
  Private Sub btnTally_Click(sender As Object, e As EventArgs) Handles btnTally.Click
    ...
    Dim winners(totals.Count - 1) As Integer 'holds indexes of candidates with highest scores
