<ExportCodeRefactoringProvider(PrivateFieldCodeRefactoringCodeRefactoringProvider.RefactoringId, LanguageNames.VisualBasic), [Shared]>
Friend Class PrivateFieldCodeRefactoringCodeRefactoringProvider
    Inherits CodeRefactoringProvider

    Public Const RefactoringId As String = "PrivateFieldCodeRefactoring"
    ...
    Public NotOverridable Overrides Async Function _
        ...
        If mustRegisterAction = False Then
            Return
        Else
            Dim action = CodeAction.Create("Make first char lower case",
