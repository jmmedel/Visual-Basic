<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="NorthwindOrders.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="NorthwindOrders" %>
